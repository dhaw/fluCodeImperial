...
%{
%Prem:
C=[7.5103    5.2350    6.0040    1.9520    0.8168;
...
%This one for paper
plim=[.5,0;%.3,0;%1,.4;
    90,-30;%90,-31;%31,-31;%.2,0;%35,-5;%60,-30;%1,0;%XX
    .5,0;%.4,0;
    %plim=[.5,0;
    .7,.4;%.605,.495;%.66,.44;%.605,.495;
    .6,.4;%.55,.45;
    200,0;%-100;%30,-5;%180,-60%XX
    3,1;%2,1.305;%1.595,1.305;%1.595,1.305;%max,min
    2,.001]';%2/3,1/4]';%1/2.7
%}
%{
plim=[.4,0;%1,.4;
    100,-100;%.2,0;%35,-5;%60,-30;%1,0;%XX
    .5,0;
    %plim=[.5,0;
    .66,.44;%.605,.495;
    .6,.4;%.55,.45;
    100,-100;%30,-5;%180,-60%XX
    1.7,1.3;%1.595,1.305;%max,min
    1,1/4]';%1/2.7
%}
%{
plim=[1,.4;
    .2,0;%35,-5;%60,-30;%1,0;%XX
    .5,0;
    %plim=[.5,0;
    1,0%.8,.44;%.66,.44;%.605,.495;%XX
    .6,0;%.6,.4;%.55,.45;%XX
    100,0;%30,-5;%180,-60%XX
    2,1;%1.595,1.305;%max,min
    2,1/4]';%1/2.7
%}
%{
plim=[1,0;
